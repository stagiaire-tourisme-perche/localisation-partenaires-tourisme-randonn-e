...
map.getView().fit([30715.735244, 6135413.374508, 151450.797162, 6220986.997340], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Localisation des partenaires de la marque Valeurs Parc par rapport au réseau des chemins de randonnée</h2>';
        return titleElement;
    })(),
